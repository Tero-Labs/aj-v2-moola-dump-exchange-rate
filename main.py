...
def dump_exhcange():
    ...
    url, params, method = dump_coin_exchange_rate('cusd', 'celo mainnet', cusd_in_celo, 1, cusd_in_celo/ceuro_in_celo,celo_mainnet_latest_block)
    exchange_rate_reqs.append({"url": url, "params": params, "method": method})

    url, params, method = dump_coin_exchange_rate('ceuro', 'celo mainnet', ceuro_in_celo, ceuro_in_celo/cusd_in_celo, 1,celo_mainnet_latest_block)
    exchange_rate_reqs.append({"url": url, "params": params, "method": method})
